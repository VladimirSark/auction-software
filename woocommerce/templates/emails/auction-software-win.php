...
<?php echo sprintf( esc_html__( "Congratulations! You've won the %1\$s auction. %2\$s to buy your product.", 'auction-software' ), esc_attr( $product_data->get_title() ), sprintf( "<a href='%s' target='_blank'>Click here</a>", esc_url( get_permalink( $product_id ) ) ) ); ?>
    <br><br>
