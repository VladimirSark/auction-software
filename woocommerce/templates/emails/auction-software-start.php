<?php
/**
 * Admin auction start email.
 *
 * This template can be overridden by copying it to yourtheme/auction-software/woocommerce/emails/auction-software-start.php
 *
...
<?php echo sprintf( esc_html__( "The auction for %1\$s has started. %2\$s to place your bid.", 'auction-software' ), esc_attr( $product_data->get_title() ), sprintf( "<a href='%s' target='_blank'>Click here</a>", esc_url( get_permalink( $product_id ) ) ) ); ?>
    <br><br>
    <div style="margin-bottom:40px">
        <table cellspacing="0" cellpadding="6" border="1" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;width:100%;font-family:'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif">
            ...
            <tr>
                ...
                <th scope="col" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">
                    <?php esc_html_e( 'Details', 'auction-software' ); ?>
                </th>
            </tr>
            </thead>
            <tbody>
